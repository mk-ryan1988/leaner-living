    ...
    <div class="col-12 col-lg-4 d-none d-lg-block">
      ...
      <div class="card-panel no-padding no-margin white h-100">
        <ul class="collection with-header checklist">
          ...
          <a @if ($user->questionnaire) disabled @endif href="{{url('/fresh-start/href="{{url('/fresh-start/payment')}}"')}}" class="@if ($user->questionnaire) complete @endif collection-item"><i class="material-icons left">list</i><span>Questionnaire</span></a>
