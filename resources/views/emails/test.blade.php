        ...
        <tr>
            <td align="center">
                <table class="content" width="100%" cellpadding="0" cellspacing="0">
                   <tr>
                       <td class="header">
                           <a href="https://fresh-start.test/">
                              <img src="https://fresh-start.test/images/LEANER-LIVING-LOGO.png" alt="" style="height: 150px; width: auto;">
                           </a>
                       </td>
                   </tr>
                            ...
                            <table class="inner-body" align="center" width="700" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="content-cell">
                                        <h2>Hello!</h2>
                                        {{-- <p><strong>You have recieved a message from:</strong> {{$input['name']}}</p>
